...
class Lap():
	...
	def getPointsDistances_mm(self):
		for i in range(len(self.PointsDistances)):
			self.PointsDistances[i] *= 10
		for i in range(0, self.POINTS_PER_LAP - len(self.PointsDistances)):
			self.PointsDistances.append(0)
		return self.PointsDistances
